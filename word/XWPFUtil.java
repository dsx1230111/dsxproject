...
public class XWPFUtil {
     ...
     */
    public static void replaceAllPictures(String key, String picturePath, int pictureType, int width, int height, XWPFDocument document,
                                          List<XWPFParagraph> paragraphs, String type) throws Exception {
...
//    page.setFirstLineIndent(2);
//    page.setAlignment(ParagraphAlignment.CENTER);//对齐方式

    // 插入条形码图片，重点在图片的长与宽设定方式
